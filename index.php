    ...
    <style>
        ...
        * {
        ...
        .hero:before {
            ...
            inset: -20% -10% auto -10%;
            height: 120%;
            background: radial-gradient(600px 300px at 20% 20%, rgba(249, 115, 22, .22), transparent 60%), radial-gradient(500px 250px at 80% 10%, rgba(16, 185, 129, .2), transparent 60%);
            filter: blur(12px);
            z-index: 0
        }
        ...
        form {
            ...
            border: 1px solid #eef2f7;
            border-radius: 14px;
            box-shadow: 0 8px 18px rgba(2, 132, 199, .06)
        }
            ...
            <div class="container inner">
                <div>
                    ...
                    <h1>Everything for home —
                        <span style="color:var(--brand)">at fair prices</span>
                    </h1>
                    <div class="chips" style="margin:10px 0 12px">
                        <span class="chip">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M20 7H4l2 12h12l2-12Z" />
                        ...
                        <span class="chip">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                ...
                                <path d="M1 1h4l2.68 12.39A2 2 0 0 0 9.62 15H19a2 2 0 0 0 2-1.65L23 6H6" />
                            </svg>
                            Quick Delivery
                        </span>
                    </div>
